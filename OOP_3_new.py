...
class Person(Human):
    ...
    def buy_house(self, house):
        if self.own_money < house.cost:
            ...
            print(f"Nice. I bought a new house. It's cost - {house.cost}.")
...
if __name__ == '__main__':
    person_instance = Person("Tanya", 23, 25000, 3000)
    house_instances1 = House(45000, 100)
    house_instances2 = House(50000, 120)
    house_instances3 = House(40150, 85)
    realtor_instance = Realtor("Pavlo", 0.20, [house_instances1, house_instances2, house_instances3])
